        ...
        <>
          ...
          <div style={{
            ...
            {[
              ...
              { key: 'confessions', label: '✝️ Confesiones' },
            ].map(f => (
              <button
                key={f.key}
                onClick={() => setFilter(f.key as 'all' | 'adoration' | 'confessions')}
                style={{
                  fontSize: '12px',
                  padding: '5px 14px',
                  borderRadius: '9999px',
                  border: filter === f.key ? '1px solid rgba(201,162,39,0.4)' : '1px solid transparent',
                  cursor: 'pointer',
                  background: filter === f.key
                    ? 'linear-gradient(135deg, rgba(201,162,39,0.28), rgba(201,162,39,0.14))'
                    : 'transparent',
                  color: filter === f.key ? '#E8C55A' : 'rgba(245,240,232,0.55)',
              ...
              <div style={{ padding: '14px 20px 24px' }}>
                ...
                <div style={{ display: 'flex', gap: '8px', marginBottom: '14px' }}>
                  {selected.has_adoration && (
                    <span style={{
                      ...
                      color: 'var(--gold-light)', fontSize: '12px',
                  ...
                  {selected.has_confessions && (
                    <span style={{
                      ...
                      border: '1px solid rgba(201,162,39,0.2)',
                      color: 'rgba(232,197,90,0.8)', fontSize: '12px',
                      padding: '4px 12px', borderRadius: '9999px', fontWeight: '500',
                    }}>
                      ✝️ Confesiones
                    </span>
                ...
                {(selected.phone || selected.website) && (
                  <div style={{ display: 'flex', gap: '14px', marginBottom: '16px' }}>
                    ...
                    {selected.website && (
                      <a href={selected.website} target="_blank" style={{
                        fontSize: '13px', color: 'var(--gold)',
                        textDecoration: 'none', fontWeight: '500',
                      }}>
                        🌐 Web
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  {[
                    ...
                    <button
                      key={app}
                      onClick={() => openNavigation(selected, app)}
                      style={{
